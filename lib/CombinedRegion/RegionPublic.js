    ...
    function RegionPublic() {
        ...
        _this.setBy = function (key, option) {
            ...
            return function (result) {
                if (id !== undefined) {
                    // TODO TEST ME
                    var formattedResult_1 = formatResult_1.formatResultWithId({ result: result, snapshot: snapshot, format: format, id: id, reducer: reducer, params: params });
        ...
        _this.load = function (key, asyncFunction, optionOrReducer, exOption) { return __awaiter(_this, void 0, void 0, function () {
            var option, set, loadBy;
        ...
        _this.loadBy = function (key, asyncFunction, optionOrReducer, exOption) {
            var option = getCombinedOption(optionOrReducer, exOption);
            var forceUpdate = option.forceUpdate;
            var _a = _this, private_store = _a.private_store, getResults = _a.private_getResults, private_actionTypes = _a.private_actionTypes, expiredTime = _a.expiredTime, getFetchTimes = _a.private_getFetchTimes, set = _a.set;
        ...
        _this.getValue = function (key) {
            return _this.private_getResults(key);
        };
        _this.getLoading = function (key) {
            return _this.private_getLoadings(key);
        };
        _this.getError = function (key) {
            return _this.private_getErrors(key);
        };
        _this.getFetchTime = function (key) {
            return _this.private_getFetchTimes(key);
        };
        return _this;
    }
    return RegionPublic;

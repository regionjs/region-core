...
var RegionReact = /** @class */ (function (_super) {
    ...
    function RegionReact() {
        ...
        _this.useLoading = function (key) {
            var _a = _this, private_store = _a.private_store, getLoading = _a.getLoading;
            var _b = react_1.useState(getLoading(key)), loading = _b[0], setLoading = _b[1];
            react_1.useEffect(function () {
                var didUnsubscribe = false;
                var checkForUpdates = function () {
                    if (didUnsubscribe) {
        ...
        _this.useError = function (key) {
            var _a = _this, private_store = _a.private_store, getError = _a.getError;
            var _b = react_1.useState(getError(key)), error = _b[0], setError = _b[1];
            react_1.useEffect(function () {
                var didUnsubscribe = false;
                var checkForUpdates = function () {
                    if (didUnsubscribe) {
        ...
        _this.useFetchTime = function (key) {
            var _a = _this, private_store = _a.private_store, getFetchTime = _a.getFetchTime;
            var _b = react_1.useState(getFetchTime(key)), fetchTime = _b[0], setFetchTime = _b[1];
            react_1.useEffect(function () {
                var didUnsubscribe = false;
                var checkForUpdates = function () {
                    if (didUnsubscribe) {

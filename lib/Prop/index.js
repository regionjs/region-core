...
var Prop = /** @class */ (function () {
    function Prop(config) {
        ...
        this.load = function (asyncFunction, option) { return __awaiter(_this, void 0, void 0, function () {
            var region;
            return __generator(this, function (_a) {
                region = this.region;
                return [2 /*return*/, region.load(region.name, asyncFunction, option)];
            });
        }); };
        this.loadBy = function (asyncFunction, option) { return __awaiter(_this, void 0, void 0, function () {
            var region;
            return __generator(this, function (_a) {
                region = this.region;
                return [2 /*return*/, region.loadBy(region.name, asyncFunction, option)];
            });
        }); };

...
var createCombinedRegion = function () {
    ...
    var loadBy = function (key, asyncFunction, optionOrReducer, exOption) {
        ...
        return function (params) { return __awaiter(void 0, void 0, void 0, function () {
            var result, format, reducer, id, snapshot, formattedResult_1, formattedResult, error_1, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        if (id !== undefined) {
                            formattedResult_1 = util_1.formatResultWithId({ resultOrFunc: result, snapshot: snapshot, format: format, id: id, reducer: reducer, params: params });
                            private_store.set({ key: key, results: formattedResult_1, id: id });
                            return [2 /*return*/, formattedResult_1[id]];
                        }

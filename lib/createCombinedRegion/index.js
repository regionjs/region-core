...
var createCombinedRegion = function () {
    ...
    var loadBy = function (key, asyncFunction, optionOrReducer, exOption) {
        ...
        return function (params) { return __awaiter(void 0, void 0, void 0, function () {
            var result, format, reducer, id, snapshot, formatId, formattedResult_1, formattedResult, error_1, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        private_store.load({ key: key });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 2:
                        result = _a.sent();
                        format = option.format, reducer = option.reducer, id = option.id;
                        snapshot = private_getResults(key);
                        if (id !== undefined) {
                            formatId = void 0;
                            ...
                            formattedResult_1 = util_1.formatResultWithId({ resultOrFunc: result, snapshot: snapshot, format: format, id: formatId, reducer: reducer, params: params });
                            private_store.set({ key: key, results: formattedResult_1, id: formatId });
                            return [2 /*return*/, formattedResult_1[formatId]];
                        }
                        formattedResult = util_1.formatResult({ resultOrFunc: result, snapshot: snapshot, format: format, reducer: reducer, params: params });
                        private_store.set({ key: key, result: formattedResult });
                        return [2 /*return*/, formattedResult];
                    case 3:
                        error_1 = _a.sent();
                        result = private_getResults(key);

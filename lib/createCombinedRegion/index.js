...
var createCombinedRegion = function () {
    ...
    var private_getPromises = function (key) {
        ...
        return function (params) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        result = _a.sent();
                        currentPromise = private_getPromises(key);
                        snapshot = private_getResults(key);
                        if (util_1.getAcceptLatestFlag() && promise !== currentPromise) {
    ...
    var getLoading = function (key) {
        var loadings = util_1.mapValues(private_getState(), key, function (_a) {
            var loading = _a.loading;
            return util_1.formatLoading(loading);
        });
        return util_1.selectLoading(Array.isArray(loadings) ? loadings : [loadings]);
    };
    var getError = function (key) {
        var errors = util_1.mapValues(private_getState(), key, function (_a) {
            var error = _a.error;
            return error;
        });
        return util_1.selectError(Array.isArray(errors) ? errors : [errors]);
    };
    var getFetchTime = function (key) {
        var fetchTimes = util_1.mapValues(private_getState(), key, function (_a) {
            var fetchTime = _a.fetchTime;
            return fetchTime;
        });
        return util_1.selectFetchTime(Array.isArray(fetchTimes) ? fetchTimes : [fetchTimes]);
    };

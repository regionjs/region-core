...
function createMappedRegion(initialValue, option) {
    var _this = this;
    var _a, _b;
    ...
    var loadBy = function (key, asyncFunction, optionOrReducer, exOption) {
        ...
        return function (params) { return __awaiter(_this, void 0, void 0, function () {
            var loadKey, keyString, promise, result, currentPromise, snapshot, formattedResult, error_1, currentPromise, snapshot;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        formattedResult = typeof option.reducer === 'function'
                    ...
                    case 3:
                        ...
                        private_store.set({ key: keyString, result: snapshot, error: error_1 });
                        return [2 /*return*/, getValueOrInitialValue(snapshot)];
    ...
    var connect = function (key, option) {
        ...
        return function (Display) {
            ...
            util_1.deprecate('connect is deprecated, use hooks instead. ');

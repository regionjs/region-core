...
var promiseCall = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dispatch, key, Promise, props, snapshot) {
    var result, _props$params, params, format, willFormat;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            result = void 0;
            _props$params = props.params, params = _props$params === undefined ? {} : _props$params, format = props.format, willFormat = props.willFormat;

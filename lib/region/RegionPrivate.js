...
var RegionPrivate = /** @class */ (function (_super) {
    ...
    function RegionPrivate() {
        ...
        _this.private_getLoadings = function (key) {
            ...
            return util_1.mapValues(private_getState(), 'loading', key, function (i) { return util_1.formatLoading(i, strictLoading); });
        };
        _this.private_getFetchTimes = function (key) {
            var private_getState = _this.private_getState;
            return util_1.mapValues(private_getState(), 'fetchTime', key);
        };
        _this.private_getResults = function (key) {
            var private_getState = _this.private_getState;
            return util_1.mapValues(private_getState(), 'result', key);
        };
        _this.private_getErrors = function (key) {
            var private_getState = _this.private_getState;
            return util_1.mapValues(private_getState(), 'error', key);
        };
        return _this;
    }

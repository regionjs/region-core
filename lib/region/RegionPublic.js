        ...
        _this.loadBy = function (key, asyncFunction, option) {
            ...
            return function (params) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (util_1.shouldThrottle({ asyncFunction: asyncFunction, forceUpdate: forceUpdate, key: key, snapshot: snapshot, id: id, expiredTime: expiredTime, getFetchTimes: getFetchTimes })) {

...
var _wrapSet = _interopRequireDefault(require("./wrapSet"));

var _wrapLoad = _interopRequireDefault(require("./wrapLoad"));
...
var _default = compose(_wrapReducer.default, _wrapConnect.default, _wrapLoad.default, _wrapSet.default, _wrapMapResultToProps.default, _wrapGet.default, _wrapSetConfig.default)(_RegionInitial.default);

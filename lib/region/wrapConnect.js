...
var _default = function _default(RegionIn) {
  ...
  function (_RegionIn) {
    ...
    function Region() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "connectWith", function (key, DisplayComponent, LoadingComponent) {
        if ((0, _isValidConnectKey.isValidConnectKey)(key)) {
          var _assertThisInitialize = _assertThisInitialized(_assertThisInitialized(_this)),
              mapResultToProps = _assertThisInitialize.mapResultToProps,
              silentConnect = _assertThisInitialize.silentConnect;

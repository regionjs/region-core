    ...
    function Region() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getFetchTimes", function (path) {
        ...
        var _getState2 = getState(),
            _getState2$fetchTimes = _getState2.fetchTimes,
            fetchTimes = _getState2$fetchTimes === void 0 ? {} : _getState2$fetchTimes;
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getResults", function (path) {
        ...
        var _getState3 = getState(),
            _getState3$results = _getState3.results,
            results = _getState3$results === void 0 ? {} : _getState3$results;
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getError", function (path) {
        var _assertThisInitialize5 = _assertThisInitialized(_assertThisInitialized(_this)),
            getState = _assertThisInitialize5.getState;

        var _getState4 = getState(),
            _getState4$errors = _getState4.errors,
            errors = _getState4$errors === void 0 ? {} : _getState4$errors;

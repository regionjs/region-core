...
var _default = function _default(RegionIn) {
  ...
  function (_RegionIn) {
    ...
    function Region() {
      ...
      _this.mapResultToProps = _this.mapResultToProps.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      return _this;
    }

    _createClass(Region, [{
      key: "mapResultToProps",
      value: function mapResultToProps(key) {
        var getLoading = this.getLoading,

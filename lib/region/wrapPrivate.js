...
var formatLoading = function (loading, _a) {
    var strictLoading = _a.strictLoading;
    if (loading) {
        return true;
    }
        ...
        function RegionPrivate() {
            ...
            _this.private_getLoading = function (path) {
                ...
                if (Array.isArray(mapLoadings)) {
                    return mapLoadings.map(function (i) { return formatLoading(i, { strictLoading: strictLoading }); }).reduce(function (a, b) { return a || b; }, false);
                }
                return formatLoading(mapLoadings, { strictLoading: strictLoading });
            };

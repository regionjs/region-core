            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _assertThisInitialize2 = _assertThisInitialized(_assertThisInitialized(_this)), set = _assertThisInitialize2.set;
                  return _context2.abrupt("return", set(key, asyncFunction));

                case 5:
                  _assertThisInitialize3 = _assertThisInitialized(_assertThisInitialized(_this)), getSnapshot = _assertThisInitialize3.getResults, private_actionTypes = _assertThisInitialize3.private_actionTypes, expiredTime = _assertThisInitialize3.expiredTime, getFetchTimes = _assertThisInitialize3.getFetchTimes;
                  LOAD_START = private_actionTypes.LOAD_START, SET = private_actionTypes.SET;

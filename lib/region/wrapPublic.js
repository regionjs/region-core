    ...
    function RegionPublic() {
      ...
      _defineProperty(_assertThisInitialized(_this), "set", function (key, result) {
        ...
        var _assertThisInitialize = _assertThisInitialized(_this),
            getResults = _assertThisInitialize.private_getResults,
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _assertThisInitialize3 = _assertThisInitialized(_this), set = _assertThisInitialize3.set;
                  return _context2.abrupt("return", set(key, asyncFunction));

                case 5:
                  _assertThisInitialize4 = _assertThisInitialized(_this), getResults = _assertThisInitialize4.private_getResults, private_actionTypes = _assertThisInitialize4.private_actionTypes, expiredTime = _assertThisInitialize4.expiredTime, getFetchTimes = _assertThisInitialize4.private_getFetchTimes;
                  LOAD = private_actionTypes.LOAD, SET = private_actionTypes.SET;
                  _getStore3 = (0, _store.getStore)(), dispatch = _getStore3.dispatch;

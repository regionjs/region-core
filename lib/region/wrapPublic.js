          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  _assertThisInitialize3 = _assertThisInitialized(_assertThisInitialized(_this)), getResults = _assertThisInitialize3.getResults, private_actionTypes = _assertThisInitialize3.private_actionTypes, expiredTime = _assertThisInitialize3.expiredTime, getFetchTimes = _assertThisInitialize3.getFetchTimes;

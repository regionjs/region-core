        ...
        function RegionPublic() {
            ...
            _this.setFp = function (key, _a) {
                ...
                return function (result) {
                    var formattedResult = formatResult_1.formatResult({ result: result, snapshot: snapshot, key: key, format: format });
            ...
            _this.load = function (key, asyncFunction, option) {
                ...
                return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        loadFp = this.loadFp;
                        return [2 /*return*/, loadFp(key, asyncFunction, option)(option.params)];
                    });
                });
            };
            /**
             ...
             */
            _this.loadFp = function (key, asyncFunction, option) {
                if (option === void 0) { option = {}; }
                var forceUpdate = option.forceUpdate, defaultParams = option.params, format = option.format, id = option.id;
                ...
                return function (params) { return __awaiter(_this, void 0, void 0, function () {
                    var result, formattedResult, error_1, formattedResult;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 3:
                                error_1 = _a.sent();
                                formattedResult = formatResult_1.formatResult({ error: error_1, snapshot: snapshot, format: format, id: id });
                                dispatch({ type: SET, payload: { key: key, result: formattedResult, error: error_1, withLoadEnd: true } });
                                return [2 /*return*/, formattedResult];

    ...
    function Region() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "reducer", function () {
        ...
        if (action.type === SET_RESULT) {
          ...
          var nextState = (0, _reducerPrototype.assignValueDeep)(state, ['loadings', _key2], function () {
            var v = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
            return v - 1;
          });
      ...
      var nextReducerObject = _objectSpread({}, reducerObject, _defineProperty({}, reducerPath, reducer));

...
exports.getPayloadWithId = function (_a) {
    var _b;
...
exports.getPayload = function (_a) {
    ...
    var format = option.format, reducer = option.reducer, id = option.id;
    if (id !== undefined) {
        return exports.getPayloadWithId({ key: key, resultOrFunc: result, snapshot: snapshot, format: format, id: id, reducer: reducer, params: params, option: option });
    }
